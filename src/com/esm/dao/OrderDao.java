...
public interface OrderDao extends BaseDao {
    ...
    */
    ...
    @return bean数据list
    */
    java.util.List<com.esm.model.Order> queryByMap(@Param("map") Map map, @Param("page") PageInfo pageInfo);
    ...
    */
    ...
    @return bean数据list
    */
    java.util.List<com.esm.model.Order> selectByMap(@Param("map") Map map);
}