...
public class NumberUtils {
	 ...
	 * @return
	 */
	public static String numberToYuan(Object str){
	 ...
	 * @return
	 */
	public static Integer objectToInteger(Object num){
		if(StringUtil.isEmpty(num)){
			return 0;
		}else{
			return new BigDecimal(num.toString()).intValue();
		}
	}
	 ...
	 * @return
	 */
	public static Long objectToLong(Object num){
		if(StringUtil.isEmpty(num)){
			return 0L;
		}else{
